...
- Resolución nativa: 640×360. Stretch mode `viewport`, aspect `keep`, escalado entero.
- Texture filter por defecto: `Nearest`. Sin mipmaps. Snap 2D de transforms y vértices a píxel activado.
- Tiles: 32×32 px. 1 tile = 5 pies (casilla de PF2e).
- Personajes: ~32×48 px. Retratos de diálogo: 96–128 px (capa de UI aparte).
- Vista top-down ¾. No isométrica.
