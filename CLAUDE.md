...
## PF2e y licencia
- **Terminología:** es obligatorio respetar `docs/GLOSARIO.md` en código (identificadores de dominio), UI y textos. Términos nuevos se agregan ahí antes de usarlos; los "provisorios" se usan en todos lados; los "a verificar" no van a UI ni textos hasta confirmarse.
