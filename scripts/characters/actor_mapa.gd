...
## Solo presentación: se mueve cuando se lo ordenan. Está en el grupo de actores a mantener visibles
## (las paredes que lo tapan se vuelven transparentes).
...
## Ubica al actor en una celda al instante.
